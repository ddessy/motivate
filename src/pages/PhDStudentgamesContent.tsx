...
const gameDefs: GameDef[] = [
  {
    ...
    titleKey: 'phdStudentGamesContent.title1',
    subtitleKey: 'phdStudentGamesContent.subtitle1',
    descriptionKey: 'phdStudentGamesContent.desc1',
    goalKey: 'phdStudentGamesContent.goal1',
    scoringKey: 'phdStudentGamesContent.scoring1',
    metaKey: 'phdStudentGamesContent.meta1',
    stepsKey: 'phdStudentGamesContent.steps1',
    controlsKey: 'phdStudentGamesContent.controls1',
    tipKey: 'phdStudentGamesContent.tip1',
    gameUrl: 'https://negotiations-idn8.onrender.com/',
    screenshots: [
      './assets/img/phdstudentgames/negotiations_1.jpg'
    ],
  },
  {
    id: 2,
    iconClass: 'fa fa-shield',
    titleKey: 'phdStudentGamesContent.title2',
    subtitleKey: 'phdStudentGamesContent.subtitle2',
    descriptionKey: 'phdStudentGamesContent.desc2',
    goalKey: 'phdStudentGamesContent.goal2',
    scoringKey: 'phdStudentGamesContent.scoring2',
    metaKey: 'phdStudentGamesContent.meta2',
    stepsKey: 'phdStudentGamesContent.steps2',
    controlsKey: 'phdStudentGamesContent.controls2',
    tipKey: 'phdStudentGamesContent.tip2',
    gameUrl: '/phdstudentgames/wordpuzzle/',
    screenshots: [
      './assets/img/phdstudentgames/wordpuzzle_1.jpg'
    ],
  },
];

const PhdStudentGamesContent: React.FC = () => {
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12 col-md-12">
            ...
            <h2 id="student-games">
              <strong>{t('phdStudentGamesContent.title')}</strong>
            </h2>
            <p>{t('phdStudentGamesContent.intro')}</p>
            ...
            {gameDefs.map((game, idx) => {
              ...
              return (
                <div key={game.id} id={`game-${game.id}`}>
                    ...
                    {game.screenshots.map((src, i) => (
                      <div key={i} className="col-lg-4 col-md-4 col-sm-4">
                        <img
                          src={src}
                          alt={`Screenshot ${i + 1}`}
                          style={{ width: '100%', height: 'auto', objectFit: 'cover', borderRadius: 4, border: '1px solid #ddd' }}
                        />
                      </div>
                    ))}
                  </div>
                  ...
                  <p><strong>{t('phdStudentGamesContent.labelGoal')}</strong> {t(game.goalKey)}</p>
                  <p><strong>{t('phdStudentGamesContent.labelScoring')}</strong> {t(game.scoringKey)}</p>
                  ...
                  <p>
                    <a href={game.gameUrl} className="btn btn-primary" target="_blank" rel="noopener noreferrer">
                      <i className="fa fa-play"></i>&nbsp;{t('phdStudentGamesContent.playButton')}
                    </a>
                  </p>

                  {/* ── Steps ── */}
                  <h4 style={{ color: '#FB9351', marginTop: 20, marginBottom: 10 }}>
                    <i className="fa fa-list-ol"></i>&nbsp;{t('phdStudentGamesContent.labelSteps')}
                  </h4>
                  <div className="row">
                  ...
                  <h4 style={{ color: '#FB9351', marginTop: 16, marginBottom: 10 }}>
                    <i className="fa fa-keyboard-o"></i>&nbsp;{t('phdStudentGamesContent.labelControls')}
                  </h4>
            ...
            <div style={{ textAlign: 'center', color: '#888', fontSize: 13 }}>
              <i className="fa fa-wrench"></i>&nbsp;{t('phdStudentGamesContent.integratedBy')}
            </div>
...
export default PhdStudentGamesContent;